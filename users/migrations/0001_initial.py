    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('librarian', 'Библиотекарь'), ('reader', 'Читатель')], max_length=10, verbose_name='Тип пользователя')),
                ('employee_number', models.CharField(blank=True, max_length=20, null=True, verbose_name='Табельный номер')),
